...
https://miro.medium.com/max/700/1*77gAAg6_Ds_-suSixVssQw.png
  ...
  allow read ;
      allow read, write: if request.auth.uid != null && request.auth.token.email.matches("Alhassan.Mousa97@gmail.com");
